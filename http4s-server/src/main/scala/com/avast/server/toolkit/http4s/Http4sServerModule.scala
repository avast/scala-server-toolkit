...
object Http4sServerModule {

  /** Makes [[org.http4s.server.Server]] initialized with the given config and [[org.http4s.HttpApp]]. */
  def make[F[_]: ConcurrentEffect: Timer](config: Http4sServerConfig,
                                          httpApp: HttpApp[F],
