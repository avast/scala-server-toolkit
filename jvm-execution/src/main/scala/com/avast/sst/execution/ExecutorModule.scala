...
object ExecutorModule {
  ...
  /** Makes [[com.avast.sst.execution.ExecutorModule]] with default callback executor and extra [[cats.effect.Blocker]] executor
  ...
  /** Makes [[com.avast.sst.execution.ExecutorModule]] with the provided callback executor and extra [[cats.effect.Blocker]]
  ...
  /** Makes [[com.avast.sst.execution.ExecutorModule]] with executor and extra [[cats.effect.Blocker]] executor
    * for blocking operations.
    */
  ...
  /** Makes [[com.avast.sst.execution.ExecutorModule]] with fork-join executor and extra [[cats.effect.Blocker]] executor
    * for blocking operations.
    */
