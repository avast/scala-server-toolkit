...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "8.5.9"
  ...
  val sentry = "io.sentry" % "sentry" % "5.7.3"
  val slf4jApi = "org.slf4j" % "slf4j-api" % "1.7.36"
  val sslConfig = "com.typesafe" %% "ssl-config-core" % "0.6.1"
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.6"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.40.6"
