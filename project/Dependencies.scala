...
object Dependencies {
  ...
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.38.0"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.38.0"
