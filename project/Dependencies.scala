...
object Dependencies {
  ...
  val sentry = "io.sentry" % "sentry" % "8.1.0"
  val slf4jApi = "org.slf4j" % "slf4j-api" % "2.0.16"
  val sslConfig = "com.typesafe" %% "ssl-config-core" % "0.6.1"
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.41.8"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.41.8"
  ...
  object Versions {
    ...
    val grpc = "1.70.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.14.4"
    val micrometerJmx = "1.14.4"
    val micrometerStatsD = "1.14.4"
    val micrometerPrometheus = "1.14.4"
    val monix = "3.4.1"
