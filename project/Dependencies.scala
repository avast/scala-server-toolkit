...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "10.11.0"
  ...
  val jacksonDatabind = "com.fasterxml.jackson.core" % "jackson-databind" % "2.17.0"
  ...
  val sentry = "io.sentry" % "sentry" % "7.6.0"
  val slf4jApi = "org.slf4j" % "slf4j-api" % "2.0.12"
  val sslConfig = "com.typesafe" %% "ssl-config-core" % "0.6.1"
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.41.3"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.41.3"
