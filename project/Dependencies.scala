...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "9.7.0"
  ...
  object Versions {
    ...
    val grpc = "1.50.2"
    val http4s = "0.22.14"
    val micrometerCore = "1.10.0"
    val micrometerJmx = "1.10.0"
    val micrometerStatsD = "1.10.0"
    val micrometerPrometheus = "1.10.0"
    val monix = "3.4.1"
