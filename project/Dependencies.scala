...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "6.5.3"
  ...
  object Versions {
    ...
    val datastaxJavaDriverCore = "4.8.0"
    val doobie = "0.9.0"
    val grpc = "1.31.0"
    val http4s = "0.21.6"
    val micrometerCore = "1.5.3"
    val micrometerJmx = "1.5.3"
    val micrometerStatsD = "1.5.3"
    val monix = "3.2.2"
    val silencer = "1.7.1"
