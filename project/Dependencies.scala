...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "10.17.2"
  ...
  object Versions {
    ...
    val grpc = "1.66.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.12.9"
    val micrometerJmx = "1.12.9"
    val micrometerStatsD = "1.12.9"
    val micrometerPrometheus = "1.12.9"
    val monix = "3.4.1"
