...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "6.3.1"
  ...
  object Versions {
    ...
    val datastaxJavaDriverCore = "4.5.1"
    val doobie = "0.8.8"
    val grpc = "1.28.0"
    val http4s = "0.21.1"
    val micrometerCore = "1.3.6"
    val micrometerJmx = "1.3.6"
    val micrometerStatsD = "1.3.6"
    val monix = "3.1.0"
    val silencer = "1.6.0"
