...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "11.20.1"
  ...
  object Versions {
    ...
    val grpc = "1.78.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.16.2"
    val micrometerJmx = "1.16.2"
    val micrometerStatsD = "1.16.2"
    val micrometerPrometheus = "1.16.2"
    val monix = "3.4.1"
