...
object Dependencies {
  ...
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.38.3"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.38.3"
  ...
  object Versions {
    ...
    val grpc = "1.32.1"
    val http4s = "0.21.7"
    val micrometerCore = "1.5.4"
    val micrometerJmx = "1.5.4"
    val micrometerStatsD = "1.5.4"
    val monix = "3.2.2"
    val silencer = "1.7.1"
