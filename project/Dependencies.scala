...
object Dependencies {
  ...
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.38.5"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.38.5"
