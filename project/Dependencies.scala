...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "9.10.2"
  ...
  val sentry = "io.sentry" % "sentry" % "6.10.0"
  ...
  object Versions {
    ...
    val grpc = "1.51.1"
    val http4s = "0.22.14"
    val micrometerCore = "1.10.2"
    val micrometerJmx = "1.10.2"
    val micrometerStatsD = "1.10.2"
    val micrometerPrometheus = "1.10.2"
    val monix = "3.4.1"
