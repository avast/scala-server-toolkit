...
object Dependencies {
  ...
  val sentry = "io.sentry" % "sentry" % "6.13.1"
  val slf4jApi = "org.slf4j" % "slf4j-api" % "2.0.6"
  val sslConfig = "com.typesafe" %% "ssl-config-core" % "0.6.1"
  val testContainersScalaScalaTest = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.17"
  val testContainersScalaKafka = "com.dimafeng" %% "testcontainers-scala-kafka" % "0.40.17"
