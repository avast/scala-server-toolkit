...
object Dependencies {
  ...
  val jetbrainsAnnotations = "org.jetbrains" % "annotations" % "26.0.0"
  ...
  object Versions {
    ...
    val grpc = "1.68.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.13.5"
    val micrometerJmx = "1.13.5"
    val micrometerStatsD = "1.13.5"
    val micrometerPrometheus = "1.13.5"
    val monix = "3.4.1"
