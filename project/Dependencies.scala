...
object Dependencies {
  ...
  val lettuce = "io.lettuce" % "lettuce-core" % "6.1.9.RELEASE"
  ...
  val sentry = "io.sentry" % "sentry" % "6.2.1"
  ...
  object Versions {
    ...
    val grpc = "1.47.0"
    val http4s = "0.22.14"
    val micrometerCore = "1.9.1"
    val micrometerJmx = "1.9.1"
    val micrometerStatsD = "1.9.1"
    val micrometerPrometheus = "1.9.1"
    val monix = "3.4.1"
