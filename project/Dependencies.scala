...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "11.13.3"
  ...
  object Versions {
    ...
    val grpc = "1.75.0"
    val http4s = "0.22.15"
    val micrometerCore = "1.15.4"
    val micrometerJmx = "1.15.4"
    val micrometerStatsD = "1.15.4"
    val micrometerPrometheus = "1.15.4"
    val monix = "3.4.1"
