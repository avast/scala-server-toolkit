...
object Dependencies {
  ...
  val flywayCore = "org.flywaydb" % "flyway-core" % "8.2.0"
  ...
  val sentry = "io.sentry" % "sentry" % "5.4.3"
  ...
  object Versions {
    ...
    val grpc = "1.42.1"
    val http4s = "0.22.7"
    val micrometerCore = "1.8.0"
    val micrometerJmx = "1.8.0"
    val micrometerStatsD = "1.8.0"
    val micrometerPrometheus = "1.8.0"
    val monix = "3.4.0"
